...
stg_act1 = Stage('act1', 'Act1', [
	...
	{'speaker':char_narrator, 'dialog':'Porro graeco semper ei quo, per iudico percipit ut. Exerci luptatum elaboraret mel ex, no sed debet commodo dolores. Erat liber tantas at vis. Ut possit prompta feugiat nec, summo interesset an his, debitis probatus convenire id vix. Nobis dissentiunt sed ei, cum at impetus viderer definiebas. Ius cu nominavi mediocrem, an mel iriure dolorum, et veritus inciderint ius. Ad case virtute eleifend est.', 'location': loc_queens}, 
...
stg_main_menu = Stage('main menu', 'main menu', [{'speaker':example_guy, 'dialog':'Welcome  Krill', 'location': loc_queens}], ['Start', 'Exit'])
stg_other_menu = Stage('other menu', 'other menu', [{'speaker':char_narrator, 'dialog':'Welcome  Krill', 'location': loc_queens}],  ['Start', 'Exit'])
stg_new_game = Stage('new game', 'new game', [{'speaker':example_guy, 'dialog':'Welcome  Krill', 'location': loc_queens}],  ['Start', 'Exit'])
stg_load_game = Stage('load game', 'load game', [{'speaker':char_narrator, 'dialog':'Welcome  Krill', 'location': loc_queens}],  ['Start', 'Exit'])
stg_exit = Stage('exit', 'Exiting', [{'speaker':example_guy, 'dialog':'Welcome  Krill', 'location': loc_queens}],  ['Start', 'Exit'])
stg_lost = Stage('lost', 'You Loose', [{'speaker':char_narrator, 'dialog':'You lost', 'location': loc_queens}],  ['Start', 'Exit'])
